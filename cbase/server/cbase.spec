...
%dir %{prefix}/include
%dir %{prefix}/include/libhashkit
%dir %{prefix}/include/memcached
%dir %{prefix}/include/libconflate
%dir %{prefix}/include/libvbucket
%dir %{prefix}/include/libmemcached
%dir %{prefix}/include/libmemcached/protocol
%dir %{prefix}/include/libmemcached/memcached
%dir %{prefix}/include/libmemcached/util
...
%attr(-,root,root) %{prefix}/lib/libmemcachedutil.so.1
%attr(-,root,root) %{prefix}/lib/libconflate.so.0.0.0
%attr(-,root,root) %{prefix}/lib/libconflate.la
%attr(-,root,root) %{prefix}/lib/libmemcachedutil.la
%attr(-,root,root) %{prefix}/lib/libsigar.so.0
%attr(-,root,root) %{prefix}/lib/libmemcached.so
...
%attr(-,root,root) %{prefix}/lib/libmemcachedprotocol.so.0
%attr(-,root,root) %{prefix}/lib/libmemcachedprotocol.so
%attr(-,root,root) %{prefix}/lib/libmemcachedprotocol.la
%attr(-,root,root) %{prefix}/lib/libhashkit.so.0
%attr(-,root,root) %{prefix}/lib/libvbucket.so.1
%attr(-,root,root) %{prefix}/lib/libmemcachedutil.so.1.0.0
%attr(-,root,root) %{prefix}/lib/libvbucket.so
%attr(-,root,root) %{prefix}/lib/libsigar.so.0.0.0
%attr(-,root,root) %{prefix}/lib/libmemcached.so.6
...
%attr(-,root,root) %{prefix}/lib/libhashkit.la
%attr(-,root,root) %{prefix}/lib/libhashkit.so.0.0.0
%attr(-,root,root) %{prefix}/lib/libmemcachedutil.so
%attr(-,root,root) %{prefix}/lib/pkgconfig/libmemcached.pc
%attr(-,root,root) %{prefix}/lib/pkgconfig/libconflate.pc
%attr(-,root,root) %{prefix}/lib/pkgconfig/libvbucket.pc
%attr(-,root,root) %{prefix}/lib/libvbucket.so.1.0.0
%attr(-,root,root) %{prefix}/lib/libsigar.la
%attr(-,root,root) %{prefix}/lib/libmemcached.la
%attr(-,root,root) %{prefix}/lib/libconflate.so
%attr(-,root,root) %{prefix}/lib/libhashkit.so
...
%attr(-,root,root) %{prefix}/lib/libmemcachedprotocol.so.0.0.0
%attr(-,root,root) %{prefix}/lib/libmemcached.so.6.0.0
%attr(-,root,root) %{prefix}/lib/libvbucket.la
...
%attr(-,root,root) %{prefix}/include/libhashkit/configure.h
%attr(-,root,root) %{prefix}/include/libhashkit/hashkit.h
%attr(-,root,root) %{prefix}/include/libhashkit/digest.h
%attr(-,root,root) %{prefix}/include/libhashkit/behavior.h
%attr(-,root,root) %{prefix}/include/libhashkit/types.h
%attr(-,root,root) %{prefix}/include/libhashkit/strerror.h
%attr(-,root,root) %{prefix}/include/libhashkit/visibility.h
%attr(-,root,root) %{prefix}/include/libhashkit/algorithm.h
%attr(-,root,root) %{prefix}/include/libhashkit/function.h
...
%attr(-,root,root) %{prefix}/include/libconflate/conflate.h
%attr(-,root,root) %{prefix}/include/libconflate/alarm.h
%attr(-,root,root) %{prefix}/include/libvbucket/vbucket.h
%attr(-,root,root) %{prefix}/include/libvbucket/visibility.h
%attr(-,root,root) %{prefix}/include/libmemcached/delete.h
%attr(-,root,root) %{prefix}/include/libmemcached/protocol/callback.h
%attr(-,root,root) %{prefix}/include/libmemcached/protocol/cache.h
%attr(-,root,root) %{prefix}/include/libmemcached/analyze.h
%attr(-,root,root) %{prefix}/include/libmemcached/storage.h
%attr(-,root,root) %{prefix}/include/libmemcached/flush_buffers.h
%attr(-,root,root) %{prefix}/include/libmemcached/verbosity.h
%attr(-,root,root) %{prefix}/include/libmemcached/sasl.h
%attr(-,root,root) %{prefix}/include/libmemcached/get.h
%attr(-,root,root) %{prefix}/include/libmemcached/callback.h
%attr(-,root,root) %{prefix}/include/libmemcached/exception.hpp
%attr(-,root,root) %{prefix}/include/libmemcached/hash.h
%attr(-,root,root) %{prefix}/include/libmemcached/string.h
%attr(-,root,root) %{prefix}/include/libmemcached/configure.h
%attr(-,root,root) %{prefix}/include/libmemcached/memcached.hpp
%attr(-,root,root) %{prefix}/include/libmemcached/memcached/protocol_binary.h
%attr(-,root,root) %{prefix}/include/libmemcached/stats.h
%attr(-,root,root) %{prefix}/include/libmemcached/fetch.h
%attr(-,root,root) %{prefix}/include/libmemcached/allocators.h
%attr(-,root,root) %{prefix}/include/libmemcached/util.h
%attr(-,root,root) %{prefix}/include/libmemcached/result.h
%attr(-,root,root) %{prefix}/include/libmemcached/parse.h
%attr(-,root,root) %{prefix}/include/libmemcached/quit.h
%attr(-,root,root) %{prefix}/include/libmemcached/platform.h
%attr(-,root,root) %{prefix}/include/libmemcached/version.h
%attr(-,root,root) %{prefix}/include/libmemcached/server_list.h
%attr(-,root,root) %{prefix}/include/libmemcached/memcached_util.h
%attr(-,root,root) %{prefix}/include/libmemcached/watchpoint.h
%attr(-,root,root) %{prefix}/include/libmemcached/behavior.h
%attr(-,root,root) %{prefix}/include/libmemcached/flush.h
%attr(-,root,root) %{prefix}/include/libmemcached/auto.h
%attr(-,root,root) %{prefix}/include/libmemcached/protocol_handler.h
%attr(-,root,root) %{prefix}/include/libmemcached/types.h
%attr(-,root,root) %{prefix}/include/libmemcached/strerror.h
%attr(-,root,root) %{prefix}/include/libmemcached/memcached.h
%attr(-,root,root) %{prefix}/include/libmemcached/visibility.h
%attr(-,root,root) %{prefix}/include/libmemcached/util/version.h
%attr(-,root,root) %{prefix}/include/libmemcached/util/pool.h
%attr(-,root,root) %{prefix}/include/libmemcached/util/ping.h
%attr(-,root,root) %{prefix}/include/libmemcached/server.h
%attr(-,root,root) %{prefix}/include/libmemcached/dump.h
%attr(-,root,root) %{prefix}/include/libmemcached/constants.h
%attr(-,root,root) %{prefix}/bin/cbworkloadgen
%attr(-,root,root) %{prefix}/bin/memcapable
%attr(-,root,root) %{prefix}/bin/couchbase-server
%attr(-,root,root) %{prefix}/bin/sigar_port
%attr(-,root,root) %{prefix}/bin/memerror
...
%attr(-,root,root) %{prefix}/bin/memstat
...
%attr(-,root,root) %{prefix}/bin/memcp
%attr(-,root,root) %{prefix}/bin/couchbase-cli
%attr(-,root,root) %{prefix}/bin/memslap
